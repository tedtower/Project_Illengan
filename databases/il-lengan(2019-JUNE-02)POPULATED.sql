...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jun 02, 2019 at 03:12 AM
...
INSERT INTO `transactions` (`tID`, `spID`, `tNum`, `tDate`, `tType`, `dateRecorded`) VALUES
(1, 1, '123434566', '2019-05-27', 'delivery receipt', '2019-05-27 00:00:00'),
(2, 3, '02345532', '2019-05-27', 'official receipt', '2019-05-27 00:00:00');
...
INSERT INTO `transitems` (`tiID`, `uomID`, `stID`, `tiName`, `tiPrice`, `tiDiscount`, `tiSubtotal`) VALUES
(1, 6, 7, 'Coca Cola Solo 250 ml', 850, NULL, 850),
(2, 4, 6, 'Nestle Milk 1 l', 100, NULL, 600);
...
INSERT INTO `trans_items` (`tiID`, `tID`, `tiQty`) VALUES
(1, 1, 0),
(2, 2, 0);
