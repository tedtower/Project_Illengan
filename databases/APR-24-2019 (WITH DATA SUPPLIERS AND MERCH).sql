...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Apr 24, 2019 at 07:20 AM
...
(4, 'chef', 'chef', 'chef', '0'),
(5, 'customer', 'customer', 'customer', '0');
...
INSERT INTO `poitems` (`poiID`, `vID`, `poID`, `poiName`, `poiQty`, `poiUnit`, `poiPrice`, `poiStatus`) VALUES
(1, 1, 1, 'Nestle Milk 300 ml', 3, 'Box', 100, 'pending'),
(2, 2, 1, 'Chocolate Somtehing', 2, 'Bottle', 200, 'pending');
...
(1, 1, '2019-04-24', '2019-04-30', 100, '2019-04-24 00:00:00', 'None', 'pending');
...
CREATE TABLE IF NOT EXISTS `stockitems` (
  ...
  `stStatus` enum('available','unavalable','temp unavailable','deleted') NOT NULL,
...
(1, 2, 'Milk', 'available', 'liquid'),
(2, 3, 'Chocolate Syrup', 'available', 'liquid'),
(3, 3, 'Strawberry Syrup', 'available', 'liquid'),
(4, 3, 'Almond Syrup', 'available', 'liquid');
...
(1, 'SM', '9260034128', 'sm@gmail.com', 'active', 'Baguio City'),
(2, 'Tiongsan', '09776878708', 'ts@gmail.com', 'active', 'Baguio City');
...
INSERT INTO `suppliermerchandise` (`spmID`, `vID`, `spID`, `spmDesc`, `spmUnit`, `spmPrice`) VALUES
(1, 1, 1, 'Nestle Milk 500 ml', 'box', 100),
(2, 2, 1, 'Nestle Milk 1 L', 'box', 200),
(3, 3, 1, 'Best Foods Chocolate Syrup 800 ml', 'bottle', 100),
(4, 4, 1, 'Lady\'s Choice Chocolate Syrup 200 ml', 'bottle', 50),
(5, 5, 2, 'Best Foods Strawberry Syrup 300 ml', 'bottle', 300),
(6, 6, 2, 'Lady\'s Choice Strawberry Syrup 400 ml', 'bottle', 400),
(7, 7, 2, 'Best Foods Almond Syrup 500 ml', 'bottle', 800),
(8, 8, 2, 'Lady\'s Choice Almond Syrup 600 ml', 'bottle', 900);
...
(1, 1, 'box', '500ml', 2, 4, 0, 'available'),
(2, 1, 'box', '1 Liter', 2, 4, 0, 'available'),
(3, 2, 'bottle', '800 ml', 2, 4, 0, 'available'),
(4, 2, 'bottle', '200 ml', 2, 4, 0, 'available'),
(5, 3, 'bottle', '300 ml', 2, 4, 0, 'available'),
(6, 3, 'bottle', '400 ml', 2, 4, 0, 'available'),
(7, 4, 'bottle', '500 ml', 2, 5, 0, 'available'),
(8, 4, 'bottle', '600 ml', 2, 5, 0, 'available');
