CREATE DATABASE  IF NOT EXISTS `il-lengan2` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `il-lengan2`;
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: localhost    Database: il-lengan2
-- ------------------------------------------------------
...
CREATE TABLE `activity_logs` (
  ...
  `actlog_date` datetime NOT NULL,
  `actlog_desc` mediumtext NOT NULL,
  `actlog_type` enum('Add','Update','Delete') DEFAULT NULL,
  PRIMARY KEY (`actlog_id`),
  KEY `actlog_act_id_idx` (`account_id`),
  CONSTRAINT `activity logs acct_id` FOREIGN KEY (`account_id`) REFERENCES `accounts` (`account_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `activity_logs` VALUES (1,3,'2019-04-16 00:00:00','HAHAHAHA','Add');
...
CREATE TABLE `expiration` (
  ...
  CONSTRAINT `exp_var_id` FOREIGN KEY (`var_id`) REFERENCES `variance` (`var_id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `menu` VALUES (8,5,'Benguet','Brewed Benguet coffee beans (menu w/ size)','available','Coffee.jpg'),(9,4,'Animal Fries','Potato Fries','available','Animal.jpg'),(10,9,'Pakpakyaw (Butterfly) Pea','tea siya (menu w/ temparature and different price)','available','pakpakyaw.jpg'),(11,8,'Matcha','Matcha Frappe','available','Matcha.jpg'),(12,10,'Americano','americano espresso (menu w/ temperature)','available','Black.jpg');
...
INSERT INTO `orderlist` VALUES (1,1,13,'awan',1,100,'pending','awan');
...
INSERT INTO `orderslip` VALUES (1,'t1','Marvin',100,'2019-04-16',NULL,'2019-04-16');
...
INSERT INTO `purchase_orders` VALUES (1,1,'2019-04-12','2019-04-14','pending',1000,'w/ OR'),(2,2,'2019-04-12','2019-04-15','pending',1500,'w/ OR');
...
INSERT INTO `returns` VALUES (2,2,1,1,'2019-04-12','Pending',NULL);
/*!40000 ALTER TABLE `returns` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `source_variance`
--

DROP TABLE IF EXISTS `source_variance`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `source_variance` (
  `source_id` int(11) NOT NULL,
  `var_id` int(11) NOT NULL,
...
--
-- Dumping data for table `source_variance`
--

LOCK TABLES `source_variance` WRITE;
/*!40000 ALTER TABLE `source_variance` DISABLE KEYS */;
/*!40000 ALTER TABLE `source_variance` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `sources` VALUES (1,'Tiongsan','09997090529','tiongsan@mail.com','active'),(2,'Tatum','09454218542','tatum@mail.com','active');
...
INSERT INTO `spoilage` VALUES (1,'s','2019-04-12','2019-04-12','This is a spoilage',5);
...
CREATE TABLE `stockitems` (
  ...
  `stock_status` enum('available','temp unavailable','unavailable','deleted') NOT NULL,
...
INSERT INTO `stockitems` VALUES (1,14,'Chocolate',2,'Bottle',0,'available','liquid'),(2,11,'Caramel',-5,'Bottle',0,'temp unavailable','liquid'),(3,11,'Strawberry',0,'Bottle',0,'temp unavailable','liquid'),(4,12,'Hazelnut',0,'Bottle',0,'temp unavailable','liquid'),(5,12,'Vanilla',0,'Bottle',0,'temp unavailable','liquid'),(6,13,'Matcha',0,'Bag',0,'temp unavailable','liquid'),(7,14,'Espresso',0,'Bag (kg.)',0,'temp unavailable','liquid'),(8,14,'Benguet',0,'Bag (kg.)',0,'temp unavailable','liquid'),(9,14,'Kalinga',0,'Bag (kg.)',0,'temp unavailable','liquid'),(10,14,'Sagada',0,'Bag (kg.)',0,'temp unavailable','liquid'),(11,14,'Cordillera City (Medium) Roast',0,'Bag (kg.)',0,'temp unavailable','liquid'),(12,14,'Vienna (Dark) Roast',0,'Bag (kg.)',0,'temp unavailable','liquid'),(13,15,'Honey-Coated Lemon',0,'Bag',0,'temp unavailable','liquid'),(14,15,'Chamomile',0,'Bag',0,'temp unavailable','liquid'),(15,15,'Pakpakyaw (Butterfly) Pea',0,'Bag',0,'temp unavailable','liquid'),(16,16,'Mango',0,'Bottle',0,'temp unavailable','liquid'),(17,16,'Pineapple',0,'Bottle',0,'temp unavailable','liquid'),(18,16,'Water',0,'Bottle',0,'temp unavailable','liquid'),(19,16,'Coke',0,'Bottle',0,'temp unavailable','liquid'),(20,16,'Sprite',0,'Bottle',0,'temp unavailable','liquid'),(21,16,'Royal',0,'Bottle',0,'temp unavailable','liquid'),(22,17,'Whipped Cream',0,'Bottle',0,'temp unavailable','liquid'),(23,17,'Milk',0,'Carton',0,'temp unavailable','liquid'),(24,11,'Pesto',0,'Pack',0,'temp unavailable','liquid'),(25,11,'Carbonara',0,'Pack',0,'temp unavailable','liquid'),(26,11,'Italian',0,'Pack',0,'temp unavailable','liquid'),(27,19,'Baby Back',0,'Piece',0,'temp unavailable','liquid'),(28,19,'Chicken',0,'Piece',0,'temp unavailable','liquid'),(29,19,'Chicken Wings',0,'Piece',0,'temp unavailable','liquid'),(30,19,'Burger Patty',0,'Piece',0,'temp unavailable','liquid'),(31,20,'Fettuccine',0,'Pack',0,'temp unavailable','liquid'),(32,20,'Linguine',0,'Pack',0,'temp unavailable','liquid'),(33,20,'Sphagetti',0,'Pack',0,'temp unavailable','liquid');
...
INSERT INTO `stockspoil` VALUES (1,1);
...
INSERT INTO `transactions` VALUES (1,1,'2512441',400,'2019-04-12','2019-04-12','Tiongsan Harrison','Purchase'),(2,1,'1234',320,'2019-04-11','2019-04-12','','Purchase');
...
CREATE TABLE `transitems` (
  ...
  PRIMARY KEY (`trans_id`,`po_id`,`var_id`),
  KEY `variance_idx` (`var_id`),
  KEY `purchase order_idx` (`po_id`),
  CONSTRAINT `purchase order` FOREIGN KEY (`po_id`) REFERENCES `purchase_orders` (`po_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `transactions` FOREIGN KEY (`trans_id`) REFERENCES `transactions` (`trans_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `variance` FOREIGN KEY (`var_id`) REFERENCES `variance` (`var_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `variance` (
  ...
  CONSTRAINT `var_stock_id` FOREIGN KEY (`stock_id`) REFERENCES `stockitems` (`stock_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-04-16 14:41:15
