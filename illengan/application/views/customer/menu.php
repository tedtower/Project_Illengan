...
<div class="menu_box">
    ...
    <div class="d-flex flex-wrap mb-4 menu_group">
        ...
        <div class="card cd-mw" id="<?php echo $items->menu_id; ?>">
            <span class="indicate_promo <?php echo $items->menu_id; ?>" style="position:absolute;right:0;top:0"><img
                    style="width:60px;" src="<?php echo base_url('/assets/media/customer/banner.png')?>"></span>
            <!-- Card image -->
            <a href="javascript:void(0)" onclick="freebie_promos()" class="menu_card"
                id="<?php echo $items->menu_id; ?>">
            ...
            <div class="card-body p-0 m-0 gab">
                ...
                <p class="float-right menu-price" id="mp"><span class="fs-15">₱</span><?php echo $items->pref_price; ?>
                </p>
            </div>
        </div>
        <?php }} ?>
