<script type="text/javascript" src="<?php echo base_url().'assets/js/chef/mobileListen.js' ?>"></script>
...
<script type="text/javascript" src="<?php echo base_url().'assets/js/chef/dataTablesdisp.js'?>"></script>
