  ...
  <!-- MDB core JavaScript -->
  <script type="text/javascript" src="<?php echo base_url().'application/js/mdb.min.js' ?>"></script>
  <script type="text/javascript" src="<?php echo base_url().'application/js/indec.js' ?>"></script>
