<!-- Add Modals-->
<div class="modal fade" id="addMenuSpoilages" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Add Menu Spoilages</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="<?php echo base_url() ?>adminMenuSpoilage/insert" method="get" accept-charset="utf-8">
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group">
                            <div class="form-group label-floating">
                                ...
                                <input name="Code" class="form-control" type="number" value="" id="example-number-input" min="0" oninput="validity.valid||(value='');" data-validate="required" max="" required>
                            </div>
                        </div>
                        <!--Menu ID-->
                        <div class="col-md-6 form-group">
...
<!--End Add Menu Spoilage Modal-->

<!--Start Modal Edit Menu Spoilage-->
<div class="modal fade" id="editMenuSpoilages" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <form action="<?php echo base_url() ?>adminMenuSpoilage/edit" method="get" accept-charset="utf-8">
                <div class="modal-body">
                    <!--Spoilage Code-->
                    <div class="row">
                        <div class="col-md-6 form-group">
