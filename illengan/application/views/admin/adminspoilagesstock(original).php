...
//-----------------------Populate Brochure----------------------------------------
	...
	function setSpoilagesData() {
        ...
        spoilages.forEach(table => {
			...
			<tr data-stID="${table.stID}" data-ssID="${table.ssID}" data-spoilname="${table.stName}" data-stQty="${table.stQty}" data-curQty="${table.ssQty}">
			...
			$(".updateBtn").last().on('click', function () {
				...
				$("#editSpoil").find("input[name='stID']").val($(this).closest("tr").attr(
					"data-stID"));
				$("#editSpoil").find("input[name='curQty']").val($(this).closest("tr").attr(
					"data-stID"));
