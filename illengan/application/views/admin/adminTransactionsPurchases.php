                        ...
                        <div class="card-content">
                            ...
                            <table id="transTable" class="table table-bordered dt-responsive nowrap" cellspacing="0"
                                ...
                                <tbody>
                                    ...
                                    ?>
                                    <tr data-id="<?= $purchase['iID']?>">
                                        <td><img class="accordionBtn" src="/assets/media/admin/down-arrow%20(1).png"
                                                style="height:15px;width: 15px" /></td>
                                        <td><?= $purchase['iNumber']?></td>
                                        <td><?= $purchase['spName']?></td>
                                        <td><?= $purchase['iDate']?></td>
                                        <td><?= $purchase['iTotal']?></td>
                                        <td><?= $purchase['iType']?></td>
                                        <td><?= $purchase['resolvedStatus']?></td>
                                        <td>
                                    ...
                                    <tr class="accordion" style="display:none">
                                        <td colspan="8">
                                            <div class="container" style="display:none">
                                                <span>Date Recorded: <?= $purchase['iDateRecorded']?></span>
                                                <div style="overflow:auto">
                                                    <span style="float:left;margin-right:1%">Remarks:</span>
                                                    <p style="float:left"><?= $purchase['iRemarks']?></p>
                                                    <!--Remarks of Invoice-->
                                                </div>
                                                <table class="table">
