<div class="wrapper">
    <div class="sidebar" data-color="brown" data-image="<?php echo site_url('assets/img/Coffee_1.jpg')?>">
        <!--Left Navigation Bar-->
            <div class="sidebar-wrapper" style="overflow: hidden">
                <div class="logo">
                    <img src="<?php echo site_url('assets/img/logo_lg.png')?>" alt="il-lengan-logo" style="img-align:center; width: 225px;
                        height:135px">
                </div>
