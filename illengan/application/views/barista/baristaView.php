...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="<?php echo base_url().'assets/css/barista/dataTables.bootstrap4.css'?>">
...
<body>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="order_id_edit" id="order_id_edit" class="form-control"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="table_code_edit" id="table_code_edit" class="form-control"
    ...
    <!--MODAL DONE-->
    <form>
        <div class="modal fade" id="Modal_Done" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
                ...
                success: function(data) {
                    ...
                    for (i = 0; i < data.length; i++) {
                        html += '<tr>' +
                            ...
                            data[i].order_id + '" data-menu_name="' + data[i].table_code +
                            '">Edit</a>' + ' ' +
                            '</td>' +
                            ...
                            '<a href="javascript:void(0);" class="btn btn-success btn-sm item_done" data-order_id="' +
                            data[i].order_id + '" data-menu_name="' + data[i].menu_name +
                            '" data-price="' + data[i].order_qty + '">Done</a>' + ' ' +
                            '<a href="javascript:void(0);" class="btn btn-danger btn-sm item_delete" data-order_id="' +
                            data[i].order_id + '">Remove</a>' +
                            '</td>' +
                            '</tr>';
