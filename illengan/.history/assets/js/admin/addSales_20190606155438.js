                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        <td ><input type="text" id="olDesc" name="olDesc"
                         ...
                         <td><input type="number" id="subtotal" name="subtotal" class="subtotal form-control form-control-sm" value="" readonly="readonly"></td>
...
function setSubtotal() {
    $(document).ready(function () {
        ...
        console.log("total before subPrice "+ total)
        console.log("subPrice on Compute "+subPrice );
...
$(document).ready(function() {
 ...
 function deleteItem(element) {
    ...
    if(subPrice == null) {
        ...
        $(el).find(".subtotal").removeClass("subtotal");
        $(el).removeClass('salesElem');
        var olQty = $(el).find("#olQty");
        var prPrice = $(el).find("#prPrice");
        var subtotalEl = $(el).find("#subtotal");
        $(olQty).removeAttribute("name");
        $(prPrice).removeAttribute("name");
        $(subtotalEl).removeAttribute("name");
